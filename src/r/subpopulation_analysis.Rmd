...
Let's grab the metabolic subset for the markers.
```{r}
# iHUMAN reconstruction
human_map = read_excel("D:/Data/Reconstructions/Human1/Human1_SynGO.xlsx")
```
...
## Cluster 0
```{r}
neutrophil_c0 = neutrophil_metab_mat[neutrophil_metab_mat$cluster==0 & markers$pct.1 > 0.50 & markers$pct.2 < 0.50,]$gene
FeaturePlot(neutrophils, 
            features=neutrophil_c0,
            label=TRUE,
            repel=TRUE,
...
## Cluster 1
```{r}
neutrophil_c1 = neutrophil_metab_mat[neutrophil_metab_mat$cluster==1 & markers$pct.1 > 0.50 & markers$pct.2 < 0.50,]$gene
FeaturePlot(neutrophils, 
            features=neutrophil_c1,
            label=TRUE,
            repel=TRUE,
...
## Cluster 2
```{r}
neutrophil_c2 = neutrophil_metab_mat[neutrophil_metab_mat$cluster==2 & markers$pct.1 > 0.50 & markers$pct.2 < 0.50,]$gene
FeaturePlot(neutrophils, 
            features=neutrophil_c2,
            label=TRUE,
            repel=TRUE,
...
## Cluster 3
```{r}
neutrophil_c3 = neutrophil_metab_mat[neutrophil_metab_mat$cluster==3 & markers$pct.1 > 0.50 & markers$pct.2 < 0.50,]$gene
FeaturePlot(neutrophils, 
            features=neutrophil_c3,
            label=TRUE,
            repel=TRUE,
...
## Cluster 4
```{r}
neutrophil_c4 = neutrophil_metab_mat[neutrophil_metab_mat$cluster==4 & markers$pct.1 > 0.50 & markers$pct.2 < 0.50,]$gene
FeaturePlot(neutrophils, 
            features=neutrophil_c4,
            label=TRUE,
            repel=TRUE,
