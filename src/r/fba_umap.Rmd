...
```{r}
rm(list=ls())
load("D:/Data/scRNASeq/shea/lung.neut.Robj", verbose=TRUE)
...
Let's overlay the metabolic fluxes onto the t-SNE embedding. 
```{r}
q1 = ggplot(merged_tsne, aes(x=tSNE_1, y=tSNE_2, color=HMR_4418))+ 
        geom_point(size=1, alpha=0.5) +
        theme_minimal() +
        labs(x="t-SNE 1", 
             y="t-SNE 2",
             title="Hypoxanthine Phosphoribosyltransferase", 
             color="Flux") + 
...
q2 = ggplot(merged_tsne, aes(x=tSNE_1, y=tSNE_2, color=HMR_4574))+ 
        geom_point(size=1, alpha=0.5) +
        theme_minimal() +
...
q3 = ggplot(merged_tsne, aes(x=tSNE_1, y=tSNE_2, color=INSK)) + 
        geom_point(size=1, alpha=0.5) +
        theme_minimal() +
        labs(x="t-SNE 1", y="t-SNE 2",
...
p2 = ggplot(merged_tsne, aes(x=tSNE_1, y=tSNE_2, color=HMR_8486))+ 
        geom_point(size=1, alpha=0.5) +
        theme_minimal() +
        labs(x="t-SNE 1", y="t-SNE 2",
...
p3 = ggplot(merged_tsne, aes(x=tSNE_1, y=tSNE_2, color=HMR_4012))+ 
        geom_point(size=1, alpha=0.5) +
        theme_minimal() +
        labs(x="t-SNE 1", y="t-SNE 2",
...
p4 = ggplot(merged_tsne, aes(x=tSNE_1, y=tSNE_2, color=HMR_4085))+ 
        geom_point(size=1, alpha=0.5) +
        theme_minimal() +
        labs(x="t-SNE 1", y="t-SNE 2",
...
DoHeatmap(object=neut,
          ...
          #scale_fill_gradientn(name="Relative Flux", 
